...
public class FallbackIntentHandlerTest
{
    ...
    */
    ...
    public void testCanHandle_IncorrectIntentName()
    {
        ...
        IntentRequest intentRequest = mock(IntentRequest.class, Mockito.RETURNS_DEEP_STUBS);
        when(input.getRequestEnvelope().getRequest()).thenReturn(intentRequest);
        when(intentRequest.getIntent().getName()).thenReturn("anIntentThatIsNotFallbackIntent");
        ...
        // Assert
        assertFalse("canHandle should return false when any intent other than FallbackIntent is passed.", actualValue);
    }
